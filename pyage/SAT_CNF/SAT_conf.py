...
from pyage.SAT_CNF.SAT_mutation import SATMutation2, SATMutation
...
def parse_args():
    ...
    if func==0:
        mymutation = SATMutation(probability=prob)
    else:
        mymutation = SATMutation2(probability=prob)
